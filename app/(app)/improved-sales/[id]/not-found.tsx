  ...
  return (
    <main style={{
      ...
      <p style={{ fontSize: 15, color: 'var(--color-neutral-700)', margin: '0 0 var(--space-6)' }}>
        This improved sale record does not exist or may have been removed.
      </p>
      <Link href={IMPROVED_SALES_PATH.basePath} className="btn btn-primary">Back to results</Link>
    </main>
  );
}
